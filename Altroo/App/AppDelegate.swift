...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        func resetCoreData() {
            ...
            for store in coordinator.persistentStores {
                ...
                do {
                    ...
                    print("Destroyed store at \(storeURL)")
                } catch {
        ...
        func resetCloudKit() {
            ...
            let query = CKQuery(recordType: "RoutineTask", predicate: NSPredicate(value: true))
            privateDB.perform(query, inZoneWith: nil) { results, error in
                ...
                operation.modifyRecordsCompletionBlock = { _, deletedIDs, error in
                    if let error = error {
                        ...
                        print("Deleted \(deletedIDs?.count ?? 0) records from CloudKit")
                    }
                }
...
//        mockPerson()
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Altroo")
