...
//            }
    ...
    private func calcCompletion() -> CGFloat {
        ...
        checkString(mentalState?.cognitionState); checkString(mentalState?.emotionalState); checkString(mentalState?.memoryState); checkToManySet(Set(mentalState?.orientationState ?? []))
