...
class TaskDetailViewController: UIViewController {
    ...
    func setupUI() {
        ...
        let time = InfoRowView(title: "time".localized, info: DateFormatterHelper.hourFormatter(date: taskInstance.time ?? .now))
    ...
    private func configureNavBar() {
        navigationItem.title = "taskform_title".localized
